...
ALL_ELECTRONICS_FILE = os.path.join(DATA_FOLDER, "all_electronics_cleaned_for_final.csv")
HOME_ENTERTAINMENT_FILE = os.path.join(DATA_FOLDER, "home_entertainment_cleaned_for_final.csv")
AMAZON_BEST_SELLERS_FILE = os.path.join(DATA_FOLDER, "amazon_best_sellers_cleaned_for_final.csv")
DUMMYJSON_FILE = os.path.join(DATA_FOLDER, "dummyjson_products_cleaned_for_final.csv")

FINAL_COMBINED_OUTPUT = os.path.join(DATA_FOLDER, "final_combined_products_final.csv")
...
def save_dataset_summary(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "dataset_summary_final.csv")
...
def save_source_summary(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "source_summary_final.csv")
...
def save_subcategory_summary(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "subcategory_summary_final.csv")
...
def plot_price_distribution(df):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "price_distribution_final.png"))
    plt.close()
...
def plot_rating_distribution(df):
    ...
    plt.ylabel("Frequency")
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "rating_distribution_final.png"))
    plt.close()
...
def plot_price_vs_rating(df):
    ...
    plt.ylabel("Rating")
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "price_vs_rating_final.png"))
    plt.close()
...
def plot_reviewcount_vs_rating(df):
    ...
    plt.ylabel("Rating")
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "reviewcount_vs_rating_final.png"))
    plt.close()
...
def plot_average_price_by_source(source_summary):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "average_price_by_source_final.png"))
    plt.close()
...
def plot_average_rating_by_source(source_summary):
    ...
    plt.xticks(rotation=20)
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "average_rating_by_source_final.png"))
    plt.close()
...
def plot_product_count_by_source(source_summary):
    ...
    plt.xticks(rotation=20)
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "product_count_by_source_final.png"))
    plt.close()
...
def plot_log_price_by_source(df):
    ...
    plt.xticks(rotation=20)
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "log_price_by_source_final.png"))
    plt.close()
...
def plot_rating_by_source(df):
    ...
    plt.xticks(rotation=20)
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "rating_by_source_final.png"))
    plt.close()
...
def run_correlation_analysis(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "correlation_results_final.csv")
...
def run_correlation_by_source(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "correlation_by_source_final.csv")
...
def run_hypothesis_tests(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "hypothesis_tests_final.csv")
...
def run_linear_regression(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "linear_regression_summary_final.txt")
...
def save_vif_results(X):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "vif_results_final.csv")
...
def save_regression_diagnostic_plots(model):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "regression_residuals_vs_fitted_final.png"))
    plt.close()
    ...
    plt.ylabel("Frequency")
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "regression_residual_histogram_final.png"))
    plt.close()

    sm.qqplot(residuals, line="45", fit=True)
    plt.title("Regression Diagnostic: Q-Q Plot of Residuals")
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "regression_qq_plot_final.png"))
    plt.close()
...
def run_random_forest_model(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "random_forest_results_final.csv")
    ...
    feature_output_path = os.path.join(RESULTS_FOLDER, "random_forest_feature_importance_final.csv")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "random_forest_feature_importance_final.png"))
    plt.close()
...
def save_api_comparison(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "api_comparison_summary_final.csv")
    ...
    plt.ylabel("Average Rating")
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "api_comparison_average_rating_final.png"))
    plt.close()
...
def save_best_sellers_comparison(df):
    ...
    output_path = os.path.join(RESULTS_FOLDER, "best_sellers_comparison_summary_final.csv")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, "best_sellers_average_rating_final.png"))
    plt.close()
...
"""
    ...
    output_path = os.path.join(RESULTS_FOLDER, "written_summary_final.txt")
...
def main():
    ...
    df.to_csv(FINAL_COMBINED_OUTPUT, index=False)
